export function ContractNotConfiguredNotice({ action = 'this action' }: { action?: string }) {
  return (
    <div className="flex items-start gap-3 rounded-lg border border-status-warning/20 bg-status-warning/5 p-4">
      <svg viewBox="0 0 20 20" fill="currentColor" className="mt-0.5 h-5 w-5 flex-shrink-0 text-status-warning" aria-hidden="true">
        <path
          fillRule="evenodd"
      ...
      <div>
        <p className="text-body-md font-medium text-status-warning">Contract not yet configured</p>
