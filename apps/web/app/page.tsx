      ...
      <main className="pt-20">
        <section className="relative flex min-h-[85vh] flex-col items-center justify-center overflow-hidden px-margin-mobile text-center md:px-margin-desktop">
          <div className="relative z-10 max-w-4xl">
            <p className="mb-6 text-label-caps font-label-caps tracking-[0.2em] text-surface-tint">
              ESTABLISHING ARCHITECTURAL ACCOUNTABILITY
            </p>
            <h1 className="mb-8 font-display text-display leading-tight text-on-background">
              Before you trust a door, you look
              <br />
              <span className="italic text-surface-tint">through the NexusKey first.</span>
            </h1>
            ...
            <div className="mx-auto mt-12 w-full max-w-3xl">
              <PropertySearchBar />
              <p className="mt-4 text-body-sm italic text-on-surface-variant/60">
          ...
          <div className="grid grid-cols-1 gap-gutter md:grid-cols-12">
            <div className="group relative overflow-hidden rounded-xl border border-border-subtle bg-surface-card p-12 transition-all hover:border-surface-tint/40 md:col-span-8">
              <div className="relative z-10 max-w-md">
                <div className="mb-6 flex items-center gap-3">
                  <span className="rounded-lg bg-surface-tint/10 p-2 text-surface-tint">
                    <ShieldIcon />
                  </span>
                  <span className="text-label-caps font-label-caps uppercase text-surface-tint">
                    Protocol Layer 01
                  </span>
                </div>
                <h3 className="mb-4 font-headline-lg text-headline-lg text-primary">Bonded Registry</h3>
            ...
            <div className="flex flex-col justify-between rounded-xl border border-border-subtle bg-surface-card p-8 transition-all hover:border-surface-tint/40 md:col-span-4">
              <div>
                ...
                <h3 className="mb-2 font-headline-md text-headline-md text-primary">Challenge System</h3>
                <p className="text-body-md text-on-surface-variant">
              ...
              <Link
                href="/how-it-works"
                className="mt-8 flex items-center gap-2 text-label-caps font-label-caps text-surface-tint hover:underline"
              >
        ...
        <section className="border-t border-border-subtle bg-surface-container-lowest py-32">
          <div className="mx-auto max-w-container-max px-margin-mobile text-center md:px-margin-desktop">
            <h2 className="mb-16 font-headline-lg text-headline-lg text-primary">
        ...
        <section className="mx-auto max-w-container-max px-margin-mobile py-32 md:px-margin-desktop">
          <div className="relative overflow-hidden rounded-2xl border border-surface-tint/20 p-16 text-center glass-panel">
            <h2 className="mb-6 font-display text-display text-primary">Ready to secure your listing?</h2>
